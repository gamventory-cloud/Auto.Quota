...
UPDATES = [
    ("2026-09-09", [
        ("지역코드 검증", "우편번호와 주소 데이터 기반으로 시/구, 시/군/구, 행정동 데이터 생성 기능 추가"),
    ]),
    ("2026-09-07", [
        ("테이블 생성", "빈도표 기능 순위/복수응답 문항 개선, 코드 안 달린 변수 구분 기능 추가"),
        ("쿼터 솔루션", "쿼터표 엑셀 업로드 기능 개선 / 현재 설정된 쿼터표 업로드 양식 다운로드 기능 추가"),
        ("Sav → Excel", "복수의 sav 파일 변환 기능 추가"),
    ]),
    ("2026-09-03", [
        ("테이블 생성", "빈도표 기능 추가"),
    ]),
